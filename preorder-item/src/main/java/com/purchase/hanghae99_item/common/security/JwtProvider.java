package com.purchase.hanghae99_item.common.security;
...
import com.purchase.hanghae99_item.user.UserRole;
...
public class JwtProvider {
    ...
    public boolean isTokenValid(String token) {
        try {
            ...
            throw new BusinessException(ExceptionCode.UNSUPPORTED_JWT);
        } catch (MalformedJwtException e) {
            throw new BusinessException(ExceptionCode.INVALID_JWT);
        } catch (IllegalArgumentException e) {
            throw new BusinessException(ExceptionCode.ILLEGAL_ARGUMENT_JWT);
        }
        return true;
    }
    ...
    public String reissue(HttpServletRequest request, HttpServletResponse response) {
        ...
        cookieManager.setCookie(response, newAccessToken, CustomCookieManager.ACCESS_TOKEN, accessTokenExpirationPeriod);
