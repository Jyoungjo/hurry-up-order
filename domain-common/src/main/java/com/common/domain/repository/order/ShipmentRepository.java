...
public interface ShipmentRepository extends JpaRepository<Shipment, Long> {
    ...
    @Modifying
    @Query("UPDATE Shipment s SET s.deletedAt = :deletedAt WHERE s.orderItemId = orderItemId")
    void deleteAllByOrderId(@Param("deletedAt") LocalDateTime deletedAt, @Param("orderItemId") Long orderId);
}