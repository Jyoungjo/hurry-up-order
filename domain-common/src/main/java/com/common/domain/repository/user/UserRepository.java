...
public interface UserRepository extends JpaRepository<User, Long> {
    ...
    @Modifying
    @Query("UPDATE User u SET u.phoneNumber = :phoneNumber, u.address = :addr WHERE u.id = :id")
    void updateContactInfo(@Param("id") Long id, @Param("phoneNumber") String phoneNumber, @Param("addr")  String addr);
