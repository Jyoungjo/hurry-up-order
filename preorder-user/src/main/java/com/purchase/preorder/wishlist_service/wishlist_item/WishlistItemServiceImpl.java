...
import com.common.domain.repository.user.WishlistItemRepository;
import com.common.web.exception.BusinessException;
import com.purchase.preorder.user_service.api.internal.ItemClient;
import com.purchase.preorder.user_service.api.internal.ItemResponse;
...
public class WishlistItemServiceImpl implements WishlistItemService {
    ...
    public List<ResWishListItemDto> fromEntities(List<WishlistItem> wishlistItems) {
        if (wishlistItems.isEmpty()) return Collections.EMPTY_LIST;
