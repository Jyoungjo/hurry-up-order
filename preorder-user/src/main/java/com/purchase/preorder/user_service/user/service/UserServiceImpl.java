...
public class UserServiceImpl implements UserService {
    ...
    @Override
    @Transactional
    @Cacheable(key="#reqDto.email", value="loginInfo", unless = "#result == null")
    public ResLoginDto login(HttpServletResponse response, ReqLoginDto reqDto) throws Exception {
        LoginInfo loginInfo = userRepository.findLoginInfoByEmail(AesUtils.aesCBCEncode(reqDto.getEmail()))
                .orElseThrow(() -> new BusinessException(ExceptionCode.NOT_FOUND_USER));
