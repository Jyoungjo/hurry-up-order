...
@Component
public class PaymentOutboxScheduler extends AbstractOutboxScheduler {

    public PaymentOutboxScheduler(OutboxService outboxService,
    ...
    protected String getServiceName() {
        return OutboxServiceNames.PAYMENT_SERVICE.getServiceName();
    }
}
