...
import com.purchase.preorder.payment_service.common.DateTimeParser;
...
public class PaymentCompletionData {
    ...
    public static PaymentCompletionData mapFromTossResponse(TossPaymentConfirmResponse res) {
    ...
    public static PaymentCompletionData mapFromNiceResponse(NicePaymentConfirmResponse res) {
        return PaymentCompletionData.builder()
                .orderId(res.getOrderId())
