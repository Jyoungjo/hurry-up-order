...
//        // given
//        ReqPaymentInitiateDto req = new ReqPaymentInitiateDto(1L, 10000);
//
//        // when
//        ResPaymentDto res = new ResPaymentDto(1L, true);
//        when(paymentService.initiatePayment(any(ReqPaymentInitiateDto.class))).thenReturn(res);
//
//        // then
...
//
//        // when
//        when(paymentService.initiatePayment(any(ReqPaymentInitiateDto.class)))
